 ...
 * Use the {@link MyProfileFragmentBackup#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyProfileFragmentBackup extends BaseFragment implements View.OnClickListener, PopupMenu.OnMenuItemClickListener, ServiceResultReceiver.Receiver {
...
LinearLayoutManager linearLayoutManager;
    public MyProfileFragmentBackup() {
...
//     * @param param2 Parameter 2.
    ...
    public static MyProfileFragmentBackup newInstance(int param1, ArrayList<UserStory> list) {
        MyProfileFragmentBackup fragment = new MyProfileFragmentBackup();
  ...
  layBios.setVisibility(View.VISIBLE);
    ...
    private void setBriefLayout(Brief_CV briefCv) {
        if (briefCv != null) {
            ...
            System.out.println("DATA 0 " + briefCv.getBrief_cv());
...
//                        errorBody(response,false);
    ...
    {
//        userSubscriptionStoryAdapter = new UserSubscriptionStoryAdapter(context, list, userName, groupiconUrl, new ObjectCallback() {
//            @Override
//            public void getObject(Object object, int position, View view) {
//                if (position != -1) {
//                    UserStory storyData = (UserStory) object;
//
//                    showMenu(view, storyData, position);
//                }
////                                      showMenu(view,storyData,position);
...
//        recyclerView.setAdapter(userSubscriptionStoryAdapter);
    ...
    {
        storyDataArrayList= ((MyProfileActivityNew)getActivity()).storyModelsList;
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView);
        linearLayoutManager=new LinearLayoutManager(context);
        recyclerView.setLayoutManager(linearLayoutManager);

        userStoryAdapter = new UserStoryAdapter(context, storyDataArrayList, userName, groupiconUrl, new ObjectCallback() {
            @Override
            public void getObject(Object object, int position, View view) {
                if (position != -1) {
...
//                                      showMenu(view,storyData,position);
    ...
    public void setStoriesData(LinkedList<UserStory> list)
    {
