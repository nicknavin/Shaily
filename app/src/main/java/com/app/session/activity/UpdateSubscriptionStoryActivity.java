...
public class UpdateSubscriptionStoryActivity extends BaseActivity implements View.OnClickListener , ServiceResultReceiver.Receiver{
...
//
        ...
        img_audio_play.setOnClickListener(this);
        ...
        if(storyData!=null)
        {
            edtStoryTitle.setText(storyData.getStoryTitle());
            edtStoryNote.setText(storyData.getStoryText());
//            language_cd= storyData.getLanguage_cd();

           if(storyData.getStoryType().equals("image"))
           {
               if(!storyData.getStoryUrl().isEmpty())
               {
           ...
           else if(storyData.getStoryType().equals("audio"))
           {
