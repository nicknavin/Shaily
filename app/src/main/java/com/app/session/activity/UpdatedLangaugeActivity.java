...
import com.app.session.adapter.UpdatedLanguageAdapter;
...
public class UpdatedLangaugeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private UpdatedLanguageAdapter updatedLanguageAdapter;
    ...
    private void initView() {
        ...
        updatedLanguageAdapter = new UpdatedLanguageAdapter(context, languageArrayList, new ApiCallback() {
            @Override
            public void result(String x) {

            }
        });
        recyclerView.setAdapter(updatedLanguageAdapter);
...
//                            if (!preferred_lang_cd.equals(jsonObject.getString("language_cd")))
                        ...
                        updatedLanguageAdapter = new UpdatedLanguageAdapter(context, languageArrayList, new ApiCallback() {
                            @Override
                            public void result(String x) {
                                Language language=languageArrayList.get(Integer.parseInt(x));
...
//                            searchlanguageArrayList.add(language);
            ...
            if (searchlanguageArrayList.size() > 0) {
                updatedLanguageAdapter = new UpdatedLanguageAdapter(context, searchlanguageArrayList, new ApiCallback() {
                    @Override
                    public void result(String x) {
                        Language language=languageArrayList.get(Integer.parseInt(x));
                        Intent intent = new Intent();
