package com.app.session.openlive.activities;
...
import com.app.session.openlive.stats.LocalStatsData;
import com.app.session.openlive.stats.RemoteStatsData;
import com.app.session.openlive.stats.StatsData;
import com.app.session.openlive.ui.VideoGridContainer;
...
public class LiveActivity extends RtcBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        config().setChannelName("DemoGroup");
        initUI();
        initData();
    }
    ...
    private void initUI() {
        ...
        int role = getIntent().getIntExtra(
                com.app.session.openlive.Constants.KEY_CLIENT_ROLE,
        ...
        rtcEngine().setBeautyEffectOptions(beautyBtn.isActivated(),
                com.app.session.openlive.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initData() {
        mVideoDimension = com.app.session.openlive.Constants.VIDEO_DIMENSIONS[
