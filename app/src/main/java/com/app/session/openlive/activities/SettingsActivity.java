...
import com.app.session.openlive.ui.ResolutionAdapter;
...
import static com.app.session.openlive.Constants.PREF_RESOLUTION_IDX;


public class SettingsActivity extends BaseActivityAgora {
