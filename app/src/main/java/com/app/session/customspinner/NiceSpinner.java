...
public class NiceSpinner extends AppCompatTextView {
    ...
    private NiceSpinnerBaseImageAdapter adapterImag;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.mipmap.down_arrow_insta);
    ...
    public <T> void attachDataSource(@NonNull List<T> list, String type) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment,type);
        setAdapterInternal(adapter);
    }
    public <T> void attachDataSourceImage(@NonNull List<T> list) {
        adapterImag = new NiceSpinnerImageAdapter<>(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment);
        setAdapterInternal(adapter);
    }
