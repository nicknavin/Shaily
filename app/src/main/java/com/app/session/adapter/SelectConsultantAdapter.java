 ...
 */
public class SelectConsultantAdapter extends RecyclerView.Adapter<SelectConsultantAdapter.ViewHolder> {
    ...
    public SelectConsultantAdapter(Context context, ArrayList<FilterConsultant> list, ApiCallback callback) {
    ...
    @Override
    public SelectConsultantAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_consultant, parent, false);
        ViewHolder vh;
    ...
    @Override
    public void onBindViewHolder(SelectConsultantAdapter.ViewHolder holder, final int position) {
...
//                apiCallback.result(consultant1.getUser_name());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        CustomTextView contactName, user_number, txtCategory, txt_sub_catg;
