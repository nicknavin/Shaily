 ...
 */
public class OtherSubscribeGroupAdapter extends RecyclerView.Adapter<OtherSubscribeGroupAdapter.ViewHolder> {


    Context context;

    ArrayList<UserSubscriptionGroupsBody> subscriptionGroupsList = new ArrayList<>();
ApiItemCallback apiItemCallback;
String newGroup;
    public OtherSubscribeGroupAdapter(Context context, ArrayList<UserSubscriptionGroupsBody> list, ApiItemCallback callback) {
...
apiItemCallback=callback;
    ...
    @Override
    public OtherSubscribeGroupAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(OtherSubscribeGroupAdapter.ViewHolder holder, final int position)
    {


        UserSubscriptionGroupsBody group = subscriptionGroupsList.get(position);
