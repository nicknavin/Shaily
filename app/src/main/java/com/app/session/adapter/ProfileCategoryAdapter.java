...
public class ProfileCategoryAdapter extends RecyclerView.Adapter<ProfileCategoryAdapter.ViewHolder> {
    ...
    public ProfileCategoryAdapter(Context context, ArrayList<Category> list)
    {
    ...
    public ProfileCategoryAdapter(Context context, ArrayList<Category> list, boolean flag, ApiItemCallback callback)
    {
        this.context = context;
        categoryArrayList = list;
    ...
    @Override
    public ProfileCategoryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ProfileCategoryAdapter.ViewHolder holder, final int position)
    {
